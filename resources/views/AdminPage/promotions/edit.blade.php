                        ...
                        <div class="container mt-4 d-flex flex-column">
                            ...
                            <div id="descbox" class="overflow-auto" style="height: 350px">
                                ...
                                <div class="mb-3 mx-1">
                                    ...
                                    <input class="mt-2 p-2 form-control @error("shortdecs") is-invalid @enderror" style="width:100%;border-radius:5px;border:none" type="text" id="shortdecs" name="shortdecs"  autofocus required value="{{ old("shortdecs", $promotion->shortdecs) }}">
                                    @error("shortdecs")
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3 mx-1">
                                    ...
                                    <input class="mt-2 p-2 form-control @error("startdate") is-invalid @enderror" style="width:100%;border-radius:5px;border:none" type="text" id="startdate" name="startdate"  autofocus required value="{{ old("startdate", $promotion->startdate) }}">
                                    @error("startdate")
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3 mx-1">
                                    ...
                                    <input class="mt-2 p-2 form-control @error("enddate") is-invalid @enderror" style="width:100%;border-radius:5px;border:none" type="text" id="enddate" name="enddate"  autofocus required value="{{ old("enddate", $promotion->enddate) }}">
                                    @error("enddate")
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
